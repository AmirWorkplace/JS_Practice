...
function publicBusFare(people){
  let busPeople = people % 50;
  let microBusPeople = busPeople % 11;
  console.log(`The number of over peoples are : ${microBusPeople} . Which are journey by Public Bus.`);

  let fare = microBusPeople * 250;
  console.log(`The total fare of the Public Bus's People are ${fare} Tk.`);
  return fare;
}
